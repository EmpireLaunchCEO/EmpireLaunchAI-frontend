      ...
      <div className="hidden lg:flex flex-col w-64 bg-theme-surface text-foreground h-screen fixed left-0 top-0 border-r border-theme shadow-sm transition-all duration-300 z-[10005] pointer-events-auto pt-6">
        ...
        <nav className="flex-1 px-4 py-4 space-y-1 overflow-y-auto no-scrollbar relative z-[5001]">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  : "text-foreground/40 hover:text-foreground hover:bg-theme-background pointer-events-auto"
                )}
              >
          ...
          <div className="mt-8 px-4 pt-6 border-t border-theme">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">AI Brain Live</span>
            </div>
        ...
        <div className="p-6 border-t border-theme bg-theme-surface">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="w-10 h-10 rounded-2xl bg-theme-background border border-theme flex items-center justify-center shadow-lg overflow-hidden group hover:border-white/50 transition-colors shrink-0">
          ...
          <button 
            ...
            className="p-2.5 rounded-xl hover:bg-red-500/10 text-muted-foreground hover:text-red-500 transition-all shrink-0"
            title="Log Out"
          >
