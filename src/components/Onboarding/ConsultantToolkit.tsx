  ...
  return (
    <div className="space-y-10 max-w-md mx-auto">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground text-lg">AI Engines Standing By: These tools will activate automatically in your command center.</p>
      </div>
          ...
          >
            <div className="flex justify-between items-start mb-4 md:mb-6">
              ...
              <span className={cn(
                ...
                tool.type === 'Essential' ? "bg-blue-600 text-white" : "bg-slate-100 text-muted-foreground"
              )}>
                {tool.type}
              </span>
            </div>
            ...
            <div className="space-y-1 md:space-y-2">
              ...
              <p className="text-sm md:text-base text-muted-foreground font-medium leading-tight">{tool.purpose}</p>
            </div>

            <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-theme flex items-center justify-between">
