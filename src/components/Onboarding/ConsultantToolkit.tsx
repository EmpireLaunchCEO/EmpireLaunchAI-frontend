  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto">
      <div className="text-center space-y-4">
        ...
        <p className="text-theme-background0 text-lg">AI Engines Standing By: These tools will activate automatically in your command center.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        {tools.map((tool: any, i: number) => (
          <motion.div
            ...
            className="p-6 md:p-8 rounded-[32px] md:rounded-[40px] border-2 border-theme bg-theme-surface hover:border-primary transition-all group"
          >
            <div className="flex justify-between items-start mb-4 md:mb-6">
              ...
              <span className={cn(
                ...
                tool.type === 'Essential' ? "bg-primary text-white" : "bg-slate-100 text-theme-background0"
              )}>
                {tool.type}
              </span>
            </div>
            ...
            <div className="space-y-1 md:space-y-2">
              ...
              <p className="text-sm md:text-base text-theme-background0 font-medium leading-tight">{tool.purpose}</p>
            </div>

            <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-theme-background flex items-center justify-between">
              ...
              <button className="p-2.5 md:p-3 rounded-xl md:rounded-2xl bg-theme-background hover:bg-primary hover:text-white transition-all">
      ...
      <div className="p-6 md:p-8 rounded-[32px] md:rounded-[40px] bg-slate-900 text-white relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl md:rounded-3xl bg-primary flex items-center justify-center shrink-0 shadow-2xl shadow-primary/20">
