  ...
  return (
    <div className="space-y-8 md:space-y-12 max-w-3xl mx-auto">
      <div className="text-center space-y-4">
        ...
        <p className="text-theme-background0 text-base md:text-lg">Define how much control you want to hand over to the AI.</p>
      </div>

      <div className="flex p-2 md:p-3 bg-slate-100 rounded-[32px] md:rounded-[40px] relative h-24 md:h-28 items-center max-w-2xl mx-auto border-4 border-theme-background shadow-inner">
        <motion.div
        ...
        <button
          ...
          className={cn(
            ...
            mode === 'co-pilot' ? "text-primary" : "text-slate-400 hover:text-slate-600"
          )}
        >
        ...
        <button
          ...
          className={cn(
            "flex-1 flex flex-col items-center justify-center gap-1 relative z-20 transition-colors duration-500 py-3 md:py-4",
            mode === 'empire' ? "text-primary" : "text-slate-400 hover:text-slate-600"
          )}
        >
          <div className="absolute -top-3 px-2 py-0.5 bg-primary text-white text-[7px] font-black uppercase tracking-widest rounded-full shadow-lg animate-bounce">
            Recommended
          </div>
      ...
      {mode === 'empire' && (
        <motion.div 
          ...
          className="bg-primary/10 border border-primary/20 p-4 rounded-2xl max-w-xl mx-auto text-center"
        >
          <p className="text-primary text-xs font-bold leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-8 md:mt-12">
        <div className={cn(
          ...
          mode === 'co-pilot' ? "border-primary bg-primary/10/30" : "border-theme bg-theme-surface opacity-40"
        )}>
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-theme-surface shadow-sm flex items-center justify-center mb-4 md:mb-6 text-primary">
            <User className="w-5 h-5 md:w-6 h-6" />
          </div>
          <h3 className="text-lg md:text-xl font-bold text-foreground mb-2">High Control</h3>
          <p className="text-sm font-medium text-theme-background0 leading-relaxed">
        ...
        <div className={cn(
          "p-6 md:p-8 rounded-[32px] md:rounded-[40px] border-2 transition-all",
          mode === 'empire' ? "border-primary bg-primary/10/30" : "border-theme bg-theme-surface opacity-40"
        )}>
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-theme-surface shadow-sm flex items-center justify-center mb-4 md:mb-6 text-primary">
