  ...
  return (
    <div className="space-y-12 max-w-3xl mx-auto">
      <div className="text-center space-y-4">
        <h2 className="text-4xl font-black text-slate-900 tracking-tight">Automation Calibration.</h2>
        <p className="text-slate-500 text-lg">Define how much control you want to hand over to the AI.</p>
      </div>

      <div className="flex p-3 bg-slate-100 rounded-[40px] relative h-28 items-center max-w-2xl mx-auto border-4 border-slate-50 shadow-inner">
        <motion.div
          className="absolute inset-2 bg-white rounded-[32px] shadow-2xl z-10 border border-slate-100"
          initial={false}
        ...
        <button
          ...
          className={cn(
            "flex-1 flex flex-col items-center justify-center gap-1 relative z-20 transition-colors duration-500 py-4",
            mode === 'co-pilot' ? "text-blue-600" : "text-slate-400 hover:text-slate-600"
          )}
        >
          <MousePointer2 className="w-6 h-6" />
          <span className="font-black uppercase tracking-[0.2em] text-[10px]">Co-Pilot</span>
        ...
        >
          ...
          <span className="font-black uppercase tracking-[0.2em] text-[10px]">Empire Mode</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
        <div className={cn(
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-2">High Control</h3>
        ...
        <div className={cn(
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-2">High Autonomy</h3>
          <p className="text-sm font-medium text-slate-500 leading-relaxed">
