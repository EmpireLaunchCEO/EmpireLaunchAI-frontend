              ...
              {thoughts.map((thought, i) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-mono text-slate-500">{new Date(thought.timestamp).toLocaleTimeString()}</span>
                  </div>
          ...
          <div className="shrink-0 p-8 bg-slate-950 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-medium text-slate-500 max-w-[240px]">Isolated browser session. Your password is never stored or visible to the AI agent.</p>
              </div>
            </div>
