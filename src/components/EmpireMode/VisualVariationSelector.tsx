  ...
  return (
    <div className="space-y-10">
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        ...
        <h2 className="text-4xl font-black text-slate-900 tracking-tight italic">Similar but Distinct.</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {variations.map((v) => (
          <motion.button
            ...
            whileHover={{ y: -8 }}
            className={cn(
              "relative bg-white border-2 rounded-[40px] overflow-hidden transition-all text-left shadow-sm group",
              selectedId === v.id ? "border-blue-600 shadow-blue-100 shadow-2xl" : "border-slate-50 hover:border-slate-200"
            )}
          >
            ...
            <div className="p-6">
               ...
               <div className={cn(
                 ...
                 selectedId === v.id ? "bg-blue-600 border-blue-600 text-white" : "bg-white border-slate-100 text-slate-400"
               )}>
