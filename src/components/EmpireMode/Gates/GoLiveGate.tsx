    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4 bg-emerald-600/5 p-6 rounded-[32px] border border-emerald-600/10">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground font-medium italic">"Final confirmation required before I deploy your listing to {payload?.platform ?? 'your chosen platform'}."</p>
        </div>
      </div>
