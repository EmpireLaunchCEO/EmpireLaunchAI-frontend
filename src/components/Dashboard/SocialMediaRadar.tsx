          ...
          return (
            ...
            >
              ...
              <p className="text-sm text-slate-300 italic">
                "Engagement velocity is {data.metrics[0].direction === 'up' ? 'accelerating' : 'decelerating'}. I recommend {data.platform === 'TikTok' ? 'posting 2x daily during peak hours (6-9 PM)' : data.platform === 'Instagram' ? 'focusing on Reels content for higher reach' : 'optimizing video titles for search discovery'}."
              </p>
