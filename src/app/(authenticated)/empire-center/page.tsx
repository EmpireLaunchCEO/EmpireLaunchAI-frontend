          ...
          <button
            ...
            className={cn(
              ...
              activeTab === tab.id 
                ...
                : "text-theme-background0 hover:text-slate-700"
            )}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
          <AnimatePresence mode="wait">
            {activeTab === 'duties' && (
              ...
              >
                {/* Approvals Section */}
                <div className="bg-theme-surface border-2 border-theme-background rounded-[40px] p-8 space-y-6">
                      ...
                      <div key={duty.id} className="p-6 bg-theme-background rounded-3xl flex items-center justify-between gap-4 border border-transparent hover:border-blue-200 transition-all">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-theme-background0 uppercase font-black tracking-widest">{duty.platform}</p>
                          </div>
                        </div>
                        <div className="flex gap-2">
                          ...
                          <button className="p-3 bg-primary hover:bg-primary text-white rounded-xl transition-colors shadow-lg shadow-blue-200">
                ...
                <div className="bg-theme-surface border-2 border-theme-background rounded-[40px] p-8 space-y-6">
                   <div className="flex items-center justify-between">
                    ...
                    <button className="text-xs font-black text-primary uppercase tracking-widest">New Request +</button>
                  </div>
            ...
            {activeTab === 'history' && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="bg-theme-surface border-2 border-theme-background rounded-[40px] p-8 space-y-8"
              >
                <div className="flex items-center justify-between">
                ...
                <div className="overflow-hidden">
                  <table className="w-full">
                    <thead>
                      <tr className="text-left text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 border-b border-theme-background">
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Current Objective</label>
                    <textarea 
                      placeholder="e.g. Focus on maximizing Etsy visibility for the new Summer Journal collection."
                      className="w-full bg-theme-surface/5 border-2 border-white/10 rounded-3xl p-6 text-sm font-medium outline-none focus:border-primary transition-all min-h-[120px]"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button className="p-6 bg-theme-surface/5 border border-white/10 rounded-[32px] text-left hover:bg-theme-surface/10 transition-all">
                      ...
                      <p className="text-[10px] text-theme-background0 uppercase font-black mt-1">Status: Active</p>
                    </button>
                    <button className="p-6 bg-theme-surface/5 border border-white/10 rounded-[32px] text-left hover:bg-theme-surface/10 transition-all">
                      <ExternalLink className="w-6 h-6 text-purple-500 mb-4" />
                      <p className="font-bold text-sm">Auto-Posting</p>
                      <p className="text-[10px] text-theme-background0 uppercase font-black mt-1">Status: Paused</p>
                    </button>
                  </div>

                  <button className="w-full py-5 bg-primary rounded-[24px] font-black text-xs uppercase tracking-widest hover:bg-primary transition-all shadow-xl shadow-foreground/40">
                    Update Directives
                  </button>
                </div>
              </motion.div>
        ...
        <div className="space-y-8">
           ...
           <div className="bg-theme-surface border-2 border-theme-background rounded-[40px] p-8 space-y-6">
              ...
              <p className="text-xs text-theme-background0 font-medium leading-relaxed">
                Send feedback to the AI regarding past posts or research quality.
              </p>
              <input 
                type="text" 
                placeholder="Type your feedback..."
                className="w-full bg-theme-background border-2 border-transparent rounded-2xl p-4 text-xs font-bold focus:border-primary transition-all outline-none"
              />
           </div>

           <div className="bg-gradient-to-br from-indigo-600 to-primary rounded-[40px] p-8 text-white space-y-4">
