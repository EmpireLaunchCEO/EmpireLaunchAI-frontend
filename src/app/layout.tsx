  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="manifest" href="/manifest.json?v=1000" />
        <link rel="apple-touch-icon" href="/apple-v10.png" />
        <link rel="icon" href="/apple-v10.png" />
        <link rel="apple-touch-startup-image" href="/apple-v10.png" />
