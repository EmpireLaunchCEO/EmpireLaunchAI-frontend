...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link rel="manifest" href="/manifest.json?v=3.7.4" />
        <link rel="apple-touch-icon" href="/branded-globe.png?v=3.7.4" />
        <link rel="icon" href="/branded-globe.png?v=3.7.4" />
