...
async function run() {
  ...
  for (const size of sizes) {
    ...
    console.log("Reloading homepage to ensure state application...");
    await page.reload();
    await page.waitForTimeout(2000);

    // Link Center
    console.log("Navigating to Link Center...");
    await page.goto('http://localhost:3000/link-center');
    console.log("Waiting for animations and dynamic charts to settle...");
